...
\marginnote{
  ...
  \textbf{Edited by}\\
  \ifdefempty{\editorNAME}{\textcolor{darkgray}{Person 1}}
             {\editorNAME\ifdefempty{\editorORCID}{}{$^{\orcid{\editorORCID}}$}}\\
  ~\\
  %%
  \textbf{Reviewed by}\\
  \ifdefempty{\reviewerINAME}{\textcolor{darkgray}{(Person 2)}}
             {\reviewerINAME\ifdefempty{\reviewerIORCID}{}{$^{\orcid{\editorORCID}}$}}\\
  \ifdefempty{\reviewerIINAME}{\textcolor{darkgray}{(Person 3)}}
  ...
  %%
  \textbf{Published}\\
  \ifdefempty{\datePUBLISHED}{Test}{\datePUBLISHED}\\
  ~\\
  %%
  \textbf{DOI}\\
  \ifdefempty{\articleDOI}{Test}{\articleDOI}
}
